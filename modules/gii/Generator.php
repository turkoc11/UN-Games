...
abstract class Generator extends Model
{
    ...
    public function hints()
    {
        return [
            ...
            'multiLang' => 'Check "Multi Lang" for enable multi lang behavior. Type in input "Multi Lang Array" names of needed fields. Be Careful with name of fields and data (table_lang will overwrite).',
            'multiLangArray' => 'Check "Multi Lang" for enable multi lang behavior. Type in input "Multi Lang Array" names of needed fields. Be Careful with name of fields and data (table_lang will overwrite).',
            'extend' => 'Check "Extend" for enable extending model to chosen module. Type in input "Extend to" names of needed modules, separated by (;/,/ ). Be Careful with name of modules and data (extended classes will overwrite).',
            'extendTo' => 'Check "Extend" for enable extending model to chosen module. Type in input "Extend to" names of needed modules, separated by (;/,/ ). Be Careful with name of modules and data (extended classes will overwrite).',
        ];
    }
