...
$this->title = Yii::$app->mv->gt('Партнеры', [], false);
$this->params['breadcrumbs'][] = $this->title;

$created_at = (!empty(Yii::$app->request->get('PartnersSearch')['created_at'])) ?Yii::$app->request->get('PartnersSearch')['created_at'] : null;
$updated_at = (!empty(Yii::$app->request->get('PartnersSearch')['updated_at'])) ?Yii::$app->request->get('PartnersSearch')['updated_at'] : null;
?>
                ...
                'columns' => [
                    ...
                    'created_at' => [
                        ...
                        'filter' => DatePicker::widget([
                            'name' => 'PartnersSearch[created_at]',
                            'value' => $created_at,
                            'options' => [
                                'class' => "form-control",
                                'placeholder' => ''
