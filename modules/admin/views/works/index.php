...
$this->title = Yii::$app->mv->gt('Что мы делаем', [], false);
$this->params['breadcrumbs'][] = $this->title;

$created_at = (!empty(Yii::$app->request->get('WorksSearch')['created_at'])) ?Yii::$app->request->get('WorksSearch')['created_at'] : null;
$updated_at = (!empty(Yii::$app->request->get('WorksSearch')['updated_at'])) ?Yii::$app->request->get('WorksSearch')['updated_at'] : null;
?>
