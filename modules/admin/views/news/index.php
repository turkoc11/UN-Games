...
$this->title = Yii::$app->mv->gt('News', [], false);
        ...
        <div class="tb-hd-wp">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'       => 'type',
                        'filter'          => Yii::$app->params[ 'newsTypes' ],
                        'class'           => 'app\components\widgets\DataColumn',
                        'content'         => function ($model) {
                            return (isset(Yii::$app->params[ 'newsTypes' ][ $model->type ])) ? Yii::$app->params[ 'newsTypes' ][ $model->type ] : '';
                        },
                        'sortLinkOptions' => [ 'class' => 'sort-label' ],
                        'sortLinkAddOn'   => '<i class="ti-arrows-vertical"></i>',
                        'encodeLabel'     => false,
