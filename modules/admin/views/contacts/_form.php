...
<div class="box">
    ...
    <div class="box-body" style="padding: 10px 0">
        ...
        <div class="tab-content" style="padding: 10px">
            <div id="top" class="tab-pane fade in active">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <?= $form->field($model, 'moving_to')->widget(CKEditor::className(), [
                            'editorOptions' =>
                                [
                                    'preset' => 'full',
                                    'inline' => false
            ...
            <?php foreach (Lang::getBehaviorsList() as $k => $v) {
//                var_dump(Lang::getBehaviorsList()); die;
                ?>
                <div class="tab-pane fade" id="top-<?= $k ?>">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <?= $form->field($model, 'address_'. $k)->widget(CKEditor::className(), [
                                'editorOptions' =>
                                    [
                                        'preset' => 'full',
                                        'inline' => false
                        ...
                        <div class="col-sm-12">
                            <?= $form->field($model, 'moving_to_'. $k)->widget(CKEditor::className(), [
                                'editorOptions' =>
                                    [
                                        'preset' => 'full',
                                        'inline' => false
