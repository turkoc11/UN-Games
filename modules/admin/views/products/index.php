...
$this->title = Yii::$app->mv->gt('Продукти', [], false);
        ...
        <div class="tb-hd-wp">
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        'attribute'       => 'type',
                        'filter'          => Yii::$app->params[ 'types' ],
                        'class'           => 'app\components\widgets\DataColumn',
                        'content'         => function ($model) {
                            return (isset(Yii::$app->params[ 'types' ][ $model->type ])) ? Yii::$app->params[ 'types' ][ $model->type ] : '';
                        },
                        'sortLinkOptions' => [ 'class' => 'sort-label' ],
                        'sortLinkAddOn'   => '<i class="ti-arrows-vertical"></i>',
                        'encodeLabel'     => false,
                    ...
                    [
                        'attribute'       => 'in_main',
                        'filter'          => Yii::$app->params[ 'main' ],
                        'class'           => 'app\components\widgets\DataColumn',
                        'content'         => function ($model) {
                            return (isset(Yii::$app->params[ 'main' ][ $model->in_main ])) ? Yii::$app->params[ 'main' ][ $model->in_main ] : '';
                        },
                        'sortLinkOptions' => [ 'class' => 'sort-label' ],
                        'sortLinkAddOn'   => '<i class="ti-arrows-vertical"></i>',
                        'encodeLabel'     => false,
