...
$this->title = Yii::$app->mv->gt('Games', [], false);
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'headerOptions' => ['style' => 'width: 150px;'],
                        'content' => function($model){
                            return Html::img($model->image2,['style'=>'width: 150px;']);
                        }
                    ],
                    [
                        'attribute' => 'percent',
                        'headerOptions' => ['style' => 'width: 150px;'],
                        'content' => function($model){
                            return !empty($model->percent) ? $model->percent : null;
                        }
                    ],
//                    'title',
                    [
                  ...
                  [
                        ...
                        'content' => function($model){
                            return !empty($model->description) ? $model->description : null;
                        }
                    ],
                    [
                        'attribute' => 'description2',
                        'content' => function($model){
                            return !empty($model->description2) ? $model->description2 : null;
                        }
                    ],
                    // 'url:url',
                    [
                    ...
                    [
                        'attribute'       => 'position',
                        'filter'          => Yii::$app->params[ 'positions' ],
                        'class'           => 'app\components\widgets\DataColumn',
                        'content'         => function ($model) {
                            return (isset(Yii::$app->params[ 'positions' ][ $model->position ])) ? Yii::$app->params[ 'positions' ][ $model->position ] : '';
                        },
                        'sortLinkOptions' => [ 'class' => 'sort-label' ],
                        'sortLinkAddOn'   => '<i class="ti-arrows-vertical"></i>',
                        'encodeLabel'     => false,
