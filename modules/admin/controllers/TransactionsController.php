...
use app\modules\admin\models\Transactions;
    use app\modules\admin\models\TransactionsSearch;
...
return $this->redirect(['index']);
    ...
    * @param integer $id
    *
    * @return Transactions|array|null|\yii\db\ActiveRecord the loaded model
    * @throws NotFoundHttpException if the model cannot be found
    */
    protected function findModel($id)
    {
        if (!empty($model = Transactions::findOne($id))) return $model;
