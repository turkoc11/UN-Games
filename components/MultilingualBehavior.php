...
class MultilingualBehavior extends Behavior
{
    ...
    public function getTranslations()
    {
        ...
        return $owner->hasMany($this->langClassName, [$this->langForeignKey => $this->ownerPrimaryKey]);
    }
    ...
    public function getTranslation($language = null)
    {
        ...
        return $owner->hasOne($this->langClassName, [$this->langForeignKey => $this->ownerPrimaryKey])
