 ...
 */
class Differences extends \yii\db\ActiveRecord
{
    public $alias=[];
    ...
    {
        return [            
            [['title', 'position', 'template'], 'required'],
            [['description', 'description2', 'link', 'template'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'position' => Yii::t('app', 'Position in home'),
