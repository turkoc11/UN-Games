...
class Contacts extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [            
            [['title'], 'required'],
            [['description', 'phone', 'fax', 'email', 'address', 'moving_to', 'linkedin_url'], 'string'],
            [['created_at', 'updated_at'], 'integer'],
            [['image', 'address', 'moving_to'], 'string', 'max' => 255],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'linkedin_url' => Yii::t('app', 'Linkedin Url'),
    ...
    public function behaviors()
    {
        return [
            ...
            'ml' => [
                ...
                'tableName' => "{{%contacts_lang}}",
                'attributes' => [
                    'title', 'description', 'address', 'moving_to'
                ]
            ],
            // 'slug' => [
