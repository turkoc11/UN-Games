...
return [
    'srcdir' => '@webroot',
    'destdir' => '@webroot/files/u2',
    'webdir' => '@webroot',
    'baseurl' => '@web',
    'jpeg_quality' => 100,
    'plug' => [
        //absolute path to plug
        'path' => '@webroot/images/default.png',
        ...
        '100x100' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '100',    // for example: 100 | 20% (default: auto)
                        'max_height' => '100',   // for example: 100 | 20% (default: auto)
        ...
        '50x50' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '50',    // for example: 100 | 20% (default: auto)
                        'max_height' => '50',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
        ...
        '120x100' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '120',    // for example: 100 | 20% (default: auto)
                        'max_height' => '100',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
        ...
        '80x80' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '80',    // for example: 100 | 20% (default: auto)
                        'max_height' => '80',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
            ...
            'effects' => [
                [
                    ...
                    'params' => [
                        ...
                        'max_height' => '400',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
        ...
        '900x600' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '900',    // for example: 100 | 20% (default: auto)
                        'max_height' => '600',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
        ...
        '390x260' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '390',    // for example: 100 | 20% (default: auto)
                        'max_height' => '260',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
        ...
        '1360x900' => [
            'effects' => [
                [
                    'type' => 'scale_up',
                    'params' => [
                        'max_width' => '1360',    // for example: 100 | 20% (default: auto)
                        'max_height' => '900',   // for example: 100 | 20% (default: auto)
                        'allow_increase' => true // increase if image is less (default: false)
                    ]
                ],
            ],
